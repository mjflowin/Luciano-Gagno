...
const CustomCursor = () => {
  ...
  return (
    ...
    >
      <motion.div
        className="w-1.5 h-1.5 bg-gold-500 rounded-full will-change-transform"
        style={{ opacity: useTransform(isHovering, [0, 1], [1, 0]) }}
      />
    </motion.div>
  );
};
...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="relative min-h-[100svh] flex items-start justify-center pt-24 lg:pt-32 overflow-hidden"
    >
      <BackgroundScale className="w-[120vh] h-[120vh] -left-[10vw] top-[5vh] text-gold-500/5" />
      <div className="absolute inset-0 z-0 flex items-center justify-center pointer-events-none">
        <div
          className="w-[800px] h-[800px] rounded-full mix-blend-screen opacity-20"
          style={{
            background:
              "radial-gradient(circle, rgba(170,140,44,1) 0%, rgba(170,140,44,0) 70%)",
          }}
        />
      </div>
      <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 relative z-10 items-start">
        <div className="lg:col-span-7 flex flex-col justify-start pt-8 w-full max-w-[650px] mx-auto lg:mx-0">
            ...
            <h1 className="text-5xl md:text-7xl lg:text-[5.5rem] font-serif leading-[1.05] tracking-tight text-white mb-2">
              ...
              <div className="overflow-hidden">
                ...
                >
                  ...
                  <span className="text-gold-500">Proteção.</span>
                </motion.div>
              </div>
            </h1>
          </div>
          <motion.p
            ...
            className="text-lg text-white/40 font-light max-w-xl mb-12 leading-relaxed"
          >
            Engenharia jurídica silenciosa e impenetrável. Assessoria
            estratégica permanente para corporações e famílias que não aceitam
            margem para o erro.
          </motion.p>
          <motion.div
            initial={{ opacity: 0 }}
          ...
          >
            <Magnetic>
              <a
                href="#solucoes"
                className="bg-white text-black px-8 py-4 rounded-full font-bold text-xs uppercase tracking-widest hover:bg-gold-500 transition-colors flex items-center gap-2 w-max cursor-none"
              >
        ...
        <div className="lg:col-span-5 flex justify-center lg:justify-start items-start pt-16 lg:pt-8 lg:-ml-12 relative">
          <motion.div
            ...
            className="relative w-full max-w-[340px] md:max-w-[400px] lg:max-w-[460px] group flex justify-center"
          >
            <div className="w-full relative flex items-end justify-center">
              <img
                src="/luciano gagno.png"
                alt="Dr. Luciano Gagno"
                className="w-full h-auto object-contain object-bottom grayscale-0 lg:grayscale opacity-100 lg:opacity-80 group-hover:grayscale-0 group-hover:opacity-100 group-hover:scale-105 transform transition-all duration-700 origin-top"
              ...
              <div className="absolute bottom-6 w-full flex justify-center pointer-events-none px-2 lg:px-4">
                <p
                  className="text-white font-serif text-[1.1rem] sm:text-2xl md:text-3xl lg:text-[1.8rem] italic opacity-90 leading-snug w-[100%] mx-auto text-center"
                  style={{
                    textShadow:
                      "0px 4px 20px rgba(0,0,0,0.9), 0px 2px 5px rgba(0,0,0,1)",
                  }}
                >
                  "A prevenção não tem preço.
                  <br /> O litígio tem custo."
                </p>
              </div>
            </div>
          </motion.div>
...
const AnimatedNameFinal = () => {
  ...
  return (
    <section
      ref={ref}
      className="py-40 flex items-center justify-center overflow-hidden min-h-[50vh] bg-black-bg border-y border-white/5 relative"
    >
          ...
          <div key={wIdx} className="flex gap-x-1 md:gap-x-3">
            {word.split("").map((char, i) => {
              const x = useTransform(
                scrollYProgress,
                [0, 1],
                [(i % 2 === 0 ? 1 : -1) * (Math.random() * 400 + 100), 0],
              );
              ...
              return (
                <motion.span
                  ...
                  className="text-[11vw] sm:text-7xl md:text-8xl lg:text-[10vw] font-serif tracking-tighter text-white leading-none"
                >
                  {char}
                </motion.span>
              );
...
const BentoCard = ({ title, desc, icon, delay, className }: any) => (
  <motion.div
    ...
    className={`group relative glass-border rounded-[2rem] p-8 md:p-12 overflow-hidden flex flex-col justify-between ${className}`}
  >
    <div className="absolute inset-0 bg-gold-500/0 group-hover:bg-gold-500/5 transition-colors duration-700" />
    <div className="relative z-10">
      <div className="text-gold-500/80 mb-8 group-hover:text-gold-500 group-hover:scale-110 transition-transform duration-500 origin-left">
        {icon}
      </div>
      <h3 className="text-2xl md:text-3xl font-serif mb-4 text-white group-hover:text-gold-400 transition-colors">
        {title}
      </h3>
      <p className="text-white/40 font-light leading-relaxed text-sm lg:text-base max-w-sm">
        {desc}
      </p>
    </div>
  </motion.div>
...
const BentoGrid = () => (
  <section
    className="relative py-32 container mx-auto px-6 overflow-hidden"
    id="solucoes"
  >
    <BackgroundScale className="w-[120vh] h-[120vh] -left-[30vw] top-[10vh] text-white/5 opacity-50" />
    <div className="mb-16 relative z-10">
      <span className="text-gold-500 font-bold uppercase tracking-[0.3em] text-[10px] block mb-4">
        Soluções Customizadas
      </span>
      <h2 className="text-4xl md:text-6xl font-serif text-white">
        Engenharia{" "}
        <span className="italic text-white/50 border-b border-gold-500/30">
          Corporativa
        </span>
      </h2>
    </div>
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[300px] md:auto-rows-[350px]">
      <BentoCard
        ...
        desc="Isolamento de patrimônio pessoal em estruturas seguras contra contingências corporativas agressivas."
      ...
      <BentoCard
        ...
        desc="Conselho jurídico de elite integrado ao seu negócio. Atuação preventiva em tempo real."
      ...
      <BentoCard
        ...
        desc="Planejamento sucessório que garante economia drástica no ITCMD e paz estrutural familiar."
        icon={<Globe size={48} strokeWidth={1} />}
        className="md:col-span-1 border-gold-500/20"
        delay={0.3}
      />
      <BentoCard
        title="Inteligência Tributária"
        desc="Revisitação minuciosa e técnica para redução de impostos e recuperação lícita de ativos empresariais."
  ...
  return (
    <section ref={ref} className="h-[300vh] relative bg-black-bg" id="método">
      <div className="sticky top-0 h-screen flex flex-col justify-center overflow-hidden border-y border-white/5">
        ...
        <div className="container mx-auto px-6 mb-8 mt-12 w-full relative z-10">
        ...
        <motion.div
          style={{ x }}
          className="flex w-[300vw] h-full pb-32 items-center"
        >
          {[
            {
              id: "01",
              t: "Diagnóstico",
              st: "Profundo",
              d: "Mapeamento minucioso do cenário empresarial para prever litígios e passivos antes da ignição.",
            },
            {
              id: "02",
              t: "Engenharia",
              st: "Tática",
              d: "Desenho de estruturas societárias blindadas e contratos inquebráveis focados na expansão pacífica.",
            },
            {
              id: "03",
              t: "Governança",
              st: "Ativa",
              d: "Implementação e monitoramento contínuo das defesas. Atuação robusta em Tribunais Superiores.",
            },
          ].map((item, i) => (
            <div key={i} className="w-[100vw] flex-shrink-0 px-6 md:px-24">
              <div className="max-w-3xl flex flex-col">
                <h2 className="text-[150px] md:text-[250px] font-serif leading-none text-white/[0.02] font-black -mb-16 md:-mb-24 translate-x-[-10px]">
                  {item.id}
                </h2>
                <h3 className="text-5xl md:text-7xl font-serif text-white mb-6 z-10">
                  {item.t}{" "}
                  <span className="italic text-gold-500">{item.st}</span>
                </h3>
                <p className="text-xl md:text-2xl text-white/40 font-light z-10 max-w-xl">
                  {item.d}
                </p>
              </div>
            </div>
...
const About = () => {
  return (
    <section
      id="sobre"
      className="relative py-32 container mx-auto px-6 overflow-hidden border-t border-white/5"
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
        ...
        >
          <div className="w-full max-w-[340px] md:max-w-[420px] lg:max-w-[460px] mx-auto relative z-10">
            <img
              src="/luciano.png"
              alt="Dr. Luciano Gagno"
              className="w-full h-auto object-contain object-bottom grayscale-0 lg:grayscale opacity-100 lg:opacity-80 hover:grayscale-0 hover:opacity-100 hover:scale-105 transform transition-all duration-700 origin-bottom"
              style={{ willChange: "transform, filter" }}
              referrerPolicy="no-referrer"
              loading="lazy"
            />
          ...
          {/* Decor */}
          <div
            className="absolute left-1/2 -translate-x-1/2 bottom-0 w-full max-w-md h-64 rounded-full pointer-events-none z-0 opacity-40 mix-blend-screen"
            style={{
              background:
                "radial-gradient(circle, rgba(170,140,44,0.5) 0%, rgba(170,140,44,0) 70%)",
            }}
          />
        </motion.div>
        ...
        <div>
          ...
          <h2 className="text-4xl md:text-6xl font-serif text-white mb-8">
            Quem é <br />
            <span className="text-gold-500 italic">Luciano Gagno</span>
          </h2>

          <div className="space-y-6 text-white/40 font-light text-base md:text-lg leading-relaxed">
            <p>
              Com quase duas décadas de atuação impecável, Luciano Gagno é
              Doutor em Processo Civil pela Universidade de São Paulo (USP) e
              autor de livros fundamentais para a doutrina moderna.
            </p>
            <p>
              Sua abordagem une o rigor acadêmico de excelência com uma visão
              empreendedora de negócios. Não há espaço para o risco não
              calculado. Como professor universitário, formou não apenas alunos,
              mas mentes preparadas para blindar legados intransponíveis.
            </p>
          </div>
...
const Footer = () => (
  <footer className="pt-32 pb-12 bg-black-bg border-t border-white/5 relative overflow-hidden">
    <div
      className="absolute top-0 right-0 w-[500px] h-[500px] rounded-full pointer-events-none opacity-20 mix-blend-screen"
      style={{
        background:
          "radial-gradient(circle, rgba(170,140,44,0.3) 0%, rgba(170,140,44,0) 70%)",
      }}
    />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-24 items-start">
        <div className="lg:col-span-2">
          ...
          <p className="text-white/40 max-w-sm mb-8 font-light text-sm">
            Seu patrimônio não pode ficar à mercê do mercado. Solicite uma
            auditoria jurídica gratuita.
          </p>
          <Magnetic>
            <a
              href="https://wa.me/5527998118489"
              target="_blank"
              rel="noreferrer"
              className="inline-block bg-white text-black px-8 py-3 rounded-full text-xs font-bold uppercase tracking-widest hover:bg-gold-500 transition-all"
            >
              Contato Imediato
            </a>
          </Magnetic>
        ...
        <div>
          <h4 className="text-gold-500 text-[10px] uppercase tracking-[0.2em] font-bold mb-6">
            Expertise
          </h4>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm text-white/50">
            ...
            <li>
              <a
                href="https://www.instagram.com/lucianogagnoadvogado/"
                target="_blank"
                rel="noreferrer"
                className="hover:text-white transition-colors"
              >
...
const FloatingWhatsApp = () => {
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 md:bottom-10 md:right-10 z-[100] bg-[#25D366] text-white p-3 md:p-4 rounded-full shadow-2xl hover:bg-[#1EBE57] hover:scale-110 transition-all flex items-center justify-center border border-white/10"
